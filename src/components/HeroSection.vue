<template>
  <section class="hero">
    ...
    <svg viewBox="0 0 2500 1600" xmlns="http://www.w3.org/2000/svg" class="first-text-effect">
      ...
      <text><textPath ref="path1Ref" href="#sv-curve1" startOffset="10">XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS</textPath></text>
    </svg>
    <svg viewBox="0 0 2500 1600" xmlns="http://www.w3.org/2000/svg" class="second-text-effect">
      ...
      <text><textPath ref="path2Ref" href="#sv-curve2" startOffset="10">XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS</textPath></text>
    </svg>
    <svg viewBox="0 0 2363 984" xmlns="http://www.w3.org/2000/svg" class="third-text-effect">
      ...
      <text><textPath ref="path3Ref" href="#sv-curve3" startOffset="10">XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS</textPath></text>
    </svg>
    <svg viewBox="0 0 1124 2198" xmlns="http://www.w3.org/2000/svg" class="fourth-text-effect">
      ...
      <text><textPath ref="path4Ref" href="#sv-curve4" startOffset="10">XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS</textPath></text>
    </svg>
    <svg viewBox="0 0 1124 2198" xmlns="http://www.w3.org/2000/svg" class="fifth-text-effect">
      ...
      <text><textPath ref="path5Ref" href="#sv-curve5" startOffset="10">XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS · XALOC EVENTS</textPath></text>
    </svg>
  </section>
</template>
